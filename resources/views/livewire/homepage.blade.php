<section class="hero">
    ...
    <form class="flex items-center max-w-sm mx-auto my-4">
        ...
        <div class="relative w-full">
            <input type="text" id="simple-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-[#F7D158] focus:border-[#F7D158] block w-full pe-10 p-2.5" placeholder="Cari menu di sini ..." required />
