<div class="flex flex-row justify-start items-center w-full text-[#001213]">
    <!-- All Category -->
    <a href="/" class="w-full">
        <div class="{{ request()->is('/') ? 'bg-yellow-400' : 'bg-white hover:bg-yellow-200' }} w-auto flex flex-col justify-center items-center mx-2 p-2 rounded-2xl transition">
    ...
    <a href="/{{ $data->slug }}" class="w-full">
        <div class="{{ request()->is($data->slug) ? 'bg-yellow-400' : 'bg-white hover:bg-yellow-200' }} w-auto flex flex-col justify-center items-center mx-2 p-2 rounded-2xl transition">
            <div class="icon p-2 bg-white rounded-full">
                <!-- SVG ICON -->
                <svg width="20px" height="20px" viewBox="0 0 1024 1024" class="icon" version="1.1" xmlns="http://www.w3.org/2000/svg">
                    <path d="M774.8 327.8c-50.6-4.8-97.3 4.3-131 22.7 15.9 20.3 26.1 52.1 26.1 87.9 0 29.2-6.8 55.7-17.9 75.5 28.3 16.9 64.5 28.8 104.6 32.6 96.7 9.2 179.2-32.4 184.2-92.8s-69.3-116.7-166-125.9z" fill="#FFB89A" />
            ...
            <div class="ms-1 font-medium text-[12px] my-2">{{ ucfirst($data->name) }}</div>
        </div>
    </a>
    @endforeach
</div>